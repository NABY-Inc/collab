...
@section('admin_css')
    ...
    <link rel="stylesheet" href="{{asset('public/assets/plugins/nestable/jquery-nestable.css')}}"/>
@endsection
                ...
                <div class="col-md-12">
                    <div class="d-md-flex justify-content-between align-items-center">
                        <ul class="nav nav-tabs page-header-tab">
                            <li class="nav-item"><a class="nav-link active" id="TaskBoard-tab" data-toggle="tab" href="#TaskBoard-list">Recieced Tasks</a></li>
                            <li class="nav-item"><a class="nav-link" id="TaskBoard-tab" data-toggle="tab" href="#TaskBoard-grid">Sent Tasks</a></li>
                        </ul>
            ...
            {{--<div class="row clearfix mt-2">--}}
                ...
                {{--<div class="col-lg-3 col-md-6">--}}
                    {{--<div class="card">--}}
                        {{--<div class="card-body text-center">--}}
                            {{--<h6>In progress</h6>--}}
                            {{--<div style="display:inline;width:90px;height:90px;"><canvas width="135" height="135" style="width: 90px; height: 90px;"></canvas><input type="text" class="knob" value="43" data-width="90" data-height="90" data-thickness="0.1" data-fgcolor="#6e7687" style="width: 49px; height: 30px; position: absolute; vertical-align: middle; margin-top: 30px; margin-left: -69px; border: 0px; background: none; font: bold 18px Arial; text-align: center; color: rgb(110, 118, 135); padding: 0px; -webkit-appearance: none;"></div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="col-lg-3 col-md-6">--}}
                    {{--<div class="card">--}}
                        {{--<div class="card-body text-center">--}}
                            {{--<h6>Completed</h6>--}}
                            {{--<div style="display:inline;width:90px;height:90px;"><canvas width="135" height="135" style="width: 90px; height: 90px;"></canvas><input type="text" class="knob" value="83" data-width="90" data-height="90" data-thickness="0.1" data-fgcolor="#6e7687" style="width: 49px; height: 30px; position: absolute; vertical-align: middle; margin-top: 30px; margin-left: -69px; border: 0px; background: none; font: bold 18px Arial; text-align: center; color: rgb(110, 118, 135); padding: 0px; -webkit-appearance: none;"></div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
                {{--<div class="col-lg-3 col-md-6">--}}
                    {{--<div class="card">--}}
                        {{--<div class="card-body text-center">--}}
                            {{--<h6>In Completed</h6>--}}
                            {{--<div style="display:inline;width:90px;height:90px;"><canvas width="135" height="135" style="width: 90px; height: 90px;"></canvas><input type="text" class="knob" value="12" data-width="90" data-height="90" data-thickness="0.1" data-fgcolor="#6e7687" style="width: 49px; height: 30px; position: absolute; vertical-align: middle; margin-top: 30px; margin-left: -69px; border: 0px; background: none; font: bold 18px Arial; text-align: center; color: rgb(110, 118, 135); padding: 0px; -webkit-appearance: none;"></div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
            {{--</div>--}}
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-vcenter mb-0 table_custom spacing8 text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled team-info mb-0">
                                                <li><img src="{{asset('public/assets/images/xs/avatar1.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                            </ul>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled team-info mb-0">
                                                <li><img src="{{asset('public/assets/images/xs/avatar4.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                            </ul>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-unstyled team-info mb-0">
                                                <li><img src="{{asset('public/assets/images/xs/avatar3.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                            </ul>
                                        </td>
                                        <td>
                                            <div class="text-info">Start: 3 Jun 2019</div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-options">
                                        <div class="item-action dropdown ml-2">
                                            <a href="javascript:void(0)" data-toggle="dropdown"><i class="fa fa-bars"></i></a>
                                            ...
                                            <li class="dd-item" data-id="1">
                                                <div class="dd-handle">
                                                    ...
                                                    <ul class="list-unstyled team-info">
                                                        <li><img src="{{asset('public/assets/images/xs/avatar1.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                        <li><img src="{{asset('public/assets/images/xs/avatar2.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                        <li><img src="{{asset('public/assets/images/xs/avatar5.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                    </ul>
                                                </div>
                                            </li>
                                        ...
                                        <ol class="dd-list">
                                            ...
                                            <li class="dd-item" data-id="2">
                                                <div class="dd-handle">
                                                    ...
                                                    <ul class="list-unstyled team-info">
                                                        <li><img src="{{asset('public/assets/images/xs/avatar7.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                        <li><img src="{{asset('public/assets/images/xs/avatar9.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                    </ul>
                                                </div>
                                            </li>
                                            <li class="dd-item" data-id="2">
                                            ...
                                            <li class="dd-item" data-id="1">
                                                <div class="dd-handle">
                                                    ...
                                                    <ul class="list-unstyled team-info">
                                                        <li><img src="{{asset('public/assets/images/xs/avatar4.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                        <li><img src="{{asset('public/assets/images/xs/avatar5.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                        <li><img src="{{asset('public/assets/images/xs/avatar6.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                        <li><img src="{{asset('public/assets/images/xs/avatar8.jpg')}}" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" data-original-title="Avatar"></li>
                                                    </ul>
                                                </div>
                                            </li>
                                            <li class="dd-item" data-id="2">
...
@section('admin_js')
    ...
    <script src="{{asset('public/assets/js/page/sortable-nestable.js')}}"></script>
