...
<div id="main_content">
            ...
            <div class="card-body">
                <ul class="list-group list-unstyled">
                    <li class="list-group-item mb-2">
                        <p>Default Theme</p>
                        <a href="index.html"><img src="{{asset('public/assets/images/themes/default.png')}}" class="img-fluid" /></a>
                    </li>
                    <li class="list-group-item mb-2">
                        <p>Night Mode Theme</p>
                        <a href="#"><img src="{{asset('public/assets/images/themes/dark.png')}}" class="img-fluid" /></a>
                    </li>
                    <li class="list-group-item mb-2">
                        <p>RTL Version</p>
                        <a href="#"><img src="{{asset('public/assets/images/themes/rtl.png')}}" class="img-fluid" /></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    {{--User Profile left side [ it appears when you click on the user image--}}
    <div class="user_div">
    ...
    <div id="left-sidebar" class="sidebar ">
        <h5 class="brand-name">P.C.S <a href="javascript:void(0)" class="menu_option float-right"><i class="fa fa-th font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
                            ...
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <ul class="right_chat list-unstyled w350 p-0">
                                        ...
                                        <li class="online">
                                            <a href="javascript:void(0);" class="media">
                                                <img class="media-object " src="{{asset('public/assets/images/xs/avatar5.jpg')}}" alt="">
                                                <div class="media-body">
                                        ...
                                        <li class="offline">
                                            <a href="javascript:void(0);" class="media">
                                                <img class="media-object " src="{{asset('public/assets/images/xs/avatar2.jpg')}}" alt="">
                                                <div class="media-body">
                                        ...
                                        <li class="online">
                                            <a href="javascript:void(0);" class="media">
                                                <img class="media-object " src="{{asset('public/assets/images/xs/avatar3.jpg')}}" alt="">
                                                <div class="media-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            Copyright © 2020 Project Collaborative System</a>.
                        </div>
                        <div class="col-md-6 col-sm-12 text-md-right">
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm">ITE 300 Group ..</a>
                                </li>
                            </ul>
                        </div>
                    </div>
