        ...
        <div id="rightsidebar" class="right_sidebar">
            ...
            <div class="p-4">
                ...
                <div class="form-group">
                    ...
                    {{-- <button type="button" class="btn btn-primary btn-block mt-3">Logout</button> --}}
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <ul class="list-group list-unstyled">
                        <li class="list-group-item mb-2">
                            <p>Default Theme</p>
                            <a href="index.html"><img src="{{asset('assets/images/themes/default.png')}}" class="img-fluid" /></a>
                        </li>
                        <li class="list-group-item mb-2">
                            <p>Night Mode Theme</p>
                            <a href="#"><img src="{{asset('assets/images/themes/dark.png')}}" class="img-fluid" /></a>
                        </li>
                        <li class="list-group-item mb-2">
                            <p>RTL Version</p>
                            <a href="#"><img src="{{asset('assets/images/themes/rtl.png')}}" class="img-fluid" /></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="left-sidebar" class="sidebar ">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li class="{{Request::url() === route('users.index') ? 'active' : ''}}">
                        <a href="{{route('users.index')}}">
                            <i class="fa fa-users"></i><span>System Users</span>
                        </a>
                    </li>
                    <li class="{{Request::url() === route('admin-project.index') ? 'active' : ''}}">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                Copyright © {{date('Y')}} Project Collaborative System</a>.
                            </div>
                            <div class="col-md-6 col-sm-12 text-md-right">
                                <ul class="list-inline mb-0">
                                    ...
                                    <li class="list-inline-item">
                                        <a href="javascript:void(0)">Naby</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
