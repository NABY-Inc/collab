                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="{{route('project.show', 1)}}"><span class="tag tag-blue mb-3">Web Design</span></a>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped table-vcenter mb-0 text-nowrap">
                                            ...
                                            <tbody>
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar1.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>Isidore Dilao</span></td>
                                            ...
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar2.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>Maricel Villalon</span></td>
                                                <td>Account receivable</td>
                                            ...
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar3.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>Theresa Wright</span></td>
                                                <td>Approval site</td>
                                            ...
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar4.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>Jason Porter</span></td>
                                            ...
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar5.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>Annelyn Mercado</span></td>
                                                <td>Account receivable</td>
                                                <td><span>30:00</span></td>
                                                <td>30:0 hrs</td>
                                                <td><span>None</span></td>
                                            ...
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar6.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>Sean Black</span></td>
                                            ...
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar7.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>Scott Ortega</span></td>
                                                <td>Account receivable</td>
                                            ...
                                            <tr>
                                                <td><img src="{{asset('public/assets/images/xs/avatar8.jpg')}}" alt="Avatar" class="w30 rounded-circle mr-2"> <span>David Wallace</span></td>
                                                <td>Account receivable</td>
                                                <td><span>30:00</span></td>
                                                <td>30:0 hrs</td>
                                                <td><span>None</span></td>
