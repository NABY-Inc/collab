                        ...
                        <div class="card-body">
                            <ul class="right_chat list-unstyled mb-0">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{asset('public/assets/images/xs/avatar1.jpg')}}" alt="">
                                            <div class="media-body">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4 col-sm-6">
                            <div class="card">
                                <div class="card-body widgets1">
                                    <div class="icon">
                                        <i class="fa fa-trophy text-success font-30"></i>
                                    </div>
                                    <div class="details">
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6">
                            <div class="card">
                                <div class="card-body widgets1">
                                    <div class="icon">
                                        <i class="fa fa-heart text-warning font-30"></i>
                                    </div>
                                    <div class="details">
